    ...
    <>
      ...
      <AnimatePresence>
        {detailWork && (
          ...
          >
            <motion.div
              className="relative w-full max-w-5xl overflow-hidden border-2 border-ink bg-paper shadow-[8px_8px_0_#0c0a09]"
            ...
            >
              ...
              <div className="grid overflow-auto md:grid-cols-[3fr_2fr]" style={{ maxHeight: "90vh" }}>
                {/* Image / Art */}
                <div className="relative min-h-64 border-b-2 border-ink bg-ink/5 md:border-b-0 md:border-r-2">
                  {detailWork.image ? (
                    <Image
                ...
                {/* Details panel */}
                <div className="flex flex-col justify-between overflow-auto p-8">
                  <div>
                  ...
                  <div className="mt-8 border-t-2 border-ink/10 pt-6">
                    {detailWork.forSale ? (
                      <div>
                        ...
                        <button className="mt-5 bg-ink px-6 py-3 font-mono text-sm font-bold uppercase tracking-wider text-paper transition-colors hover:bg-magenta">
                          购买 / BUY
                        </button>
                      </div>
                    ) : (
                    ...
                    {detailCreator && (
                      <Link
                        href={`/creators/${detailCreator.id}`}
                        className="mt-6 flex items-center gap-3 border-t border-ink/10 pt-5 font-mono text-xs text-ink/40 transition-colors hover:text-ink"
                        onClick={() => setDetailWork(null)}
                      >
